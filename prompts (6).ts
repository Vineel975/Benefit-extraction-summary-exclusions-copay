...
1. Determine if the current claim is SIMILAR to the previous claim.
   - Similar means: same medical condition/diagnosis, same type of procedure, same body part or contralateral (e.g. left eye vs right eye for cataract counts as similar).
   - Different conditions, different procedures, or unrelated complaints are NOT similar.
...
- If data is empty or unclear, return: "No ${section} information available."
